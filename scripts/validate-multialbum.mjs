...
assert(threeReyesCatalog.allStickersOrdered.includes('0'), '3 Reyes: falta la figura 0')
...
assert(threeReyesCatalog.allStickersOrdered.includes('F'), '3 Reyes: falta la letra F')
assert(threeReyesCatalog.allStickersOrdered.includes('E66'), '3 Reyes: falta E66')
assert(threeReyesCatalog.allStickersOrdered.includes('T48'), '3 Reyes: falta T48')
