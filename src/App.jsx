...
import { ALBUM_PATH, ALBUM_ROUTE, LEGACY_ALBUM_PATH } from './appRoutes'
  ...
  return (
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route path={ALBUM_PATH} element={<AlbumPage />} />
        <Route path={LEGACY_ALBUM_PATH} element={<Navigate to={ALBUM_ROUTE} replace />} />
        <Route path={`${LEGACY_ALBUM_PATH}/*`} element={<Navigate to={ALBUM_ROUTE} replace />} />
