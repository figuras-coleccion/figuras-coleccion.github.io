      ...
      <section className="donation-sheet" role="dialog" aria-modal="true" aria-labelledby="donation-title" onClick={event => event.stopPropagation()}>
        ...
        <div className="donation-options">
          ...
          <article className="donation-option yape-card">
            <h3>Yape</h3>
            <p>Escanea este QR desde Yape. En celular, toca la imagen para abrirla y guardarla.</p>
            <a className="donation-qr-link" href={yapeQrSrc} target="_blank" rel="noopener noreferrer" aria-label="Abrir código QR de Yape">
              <img className="donation-qr yape" src={yapeQrSrc} alt="Código QR para donar mediante Yape" />
            </a>
            <a className="donation-button yape" href={yapeQrSrc} target="_blank" rel="noopener noreferrer">Abrir QR de Yape ↗</a>
          </article>
          ...
          <article className="donation-option mercado-card">
            ...
            <div className="donation-payment-icon" aria-hidden="true">💳</div>
